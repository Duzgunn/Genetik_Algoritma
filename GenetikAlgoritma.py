...
class Genetic:
    def __init__(self, Target, Population_Number):
        ...
        self.Next_Generation = [] #Yeni nesildeki birelyerin bulunacağı dizi
    ...
    class Member: #Bireylerin tanımlandığı fonksiyon
        def __init__(self,chromosome):# Kromozom = Birey
            ...
            self.Fitness = 0 #Başlangış değeri olarak fitness değeri 0 tanımlandı
...
Target = input("Hedef Bireyi Giriniz: ") #Hedef birey
